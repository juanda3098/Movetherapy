      ...
      <div className="o-aboutus-container">
        <div className="o-aboutus-image-container">
          ...
          <div className="o-info">
            <div className="o-aboutus-info-container"></div>
            <div className="o-aboutus-info-container">
              <h1 className="o-aboutus-title">Quiénes Somos</h1>
              <div className="o-aboutus-description">
                Move Therapy es un centro de rehabilitación física fundada con
                la finalidad de prestar servicios en fisioterapia, basados en
                métodos diversos, buscando ofrecer calidad tanto humana como
                profesional, entendiendo que la principal necesidad de los
                usuarios es que un experto se interese por alcanzar unos
                objetivos junto a él, logrando una recuperación optima y
                exitosa.
              </div>
            </div>
          </div>
        ...
        <div className="o-aboutus-team">
          ...
          <h3 className="o-bottom-text-people">
            Profesionales comprometidos con el bienestar físico y emocional de
            sus usuarios, los cuales se encuentran constantemente actualizados y
            a la vanguardia en nuevas técnicas de rehabilitación, dispuestos a
          ...
          <div className="o-aboutus-people">
            ...
            <div className="o-aboutus-person">
              <img
                src={ProfileLauraG}
                className="o-aboutus-person-img"
                alt=""
              ></img>
