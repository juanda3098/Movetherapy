...
function ServicesTab() {
  return (
    <div className="o-services-container">
      <Service stImage={Img4} stTitle="FISIOTERAPIA" stDescription="Programa orientado a la recuperación física de
      ...
      <Service stImage={Img5} stTitle="DRENAJE LINFATICO" stDescription="Terapia manual que se utiliza con el objetivo
      ...
      <Service stImage={Img6}  stTitle="FISIOTERAPIA INVASIVA" stDescription="Programa orientado a la recuperación física de
      personas con lesiones musculares, articulares,
      ligamentosa y todas las relacionadas con el
      sistema osteomuscular, de igual manera
      contamos con tratamiento pre operatorio y post
      operatorio de múltiples lesiones." numOrientation="1"></Service>
      <Service stImage={Img7} stTitle="NUTRICIÓN" stDescription="El programa se encuentra orientado a todo
      tipo de población: deportista, sedentarios y/o
      personas que desean bajar de peso o
      aumentar masa muscular, promoviendo
      educación y hábitos de vida saludable." numOrientation="-1"></Service>
      <Service stImage={Img8} stTitle="READAPTACIÓN DEPORTIVA" stDescription="Programa direccionado a la fase 3 y 4 de
      ...
      tanto de manera física como en técnica." numOrientation="1"></Service>
      <Service stImage={Img9} stTitle="ACONDICIONAMIENTO FÍSICO" stDescription="Programa dirigido a personas que desean cambiar
      su estilo de vida, mejorar o potencializar sus
      capacidades físicas, coordinativas o mejorar su
      gesto deportivo de las diferentes disciplinas." numOrientation="-1"></Service>
      <Service stImage={Img11} stTitle="ACOMPAÑAMIENTO DEPORTIVO" stDescription="Es un programa orientado a la prevención,
      vigilancia y recuperación física del deportista
      antes, durante y posterior a la competencia." numOrientation="1"></Service>
      <Service stImage={Img10} stTitle="BIENESTAR LABORAL" stDescription="Programa dirigido a pequeñas, medianas y
      ...
      y actividades físicas." numOrientation="-1"></Service>
    </div>
  );
}
